...
namespace CrossfireRPG.ServerInterface.Protocol
{
    ...
    {
        protected abstract void HandleAddQuest(UInt32 Code, string Title, UInt32 Face, byte Replay, UInt32 Parent,
        ...
        private bool Parse_addquest(byte[] Message, ref int DataOffset, int DataEnd)
        {
            ...
            while (DataOffset < DataEnd)
            {
                ...
                var quest_face = BufferTokenizer.GetUInt32(Message, ref DataOffset);
