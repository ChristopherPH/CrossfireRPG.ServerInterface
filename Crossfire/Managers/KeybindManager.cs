...
namespace Crossfire.Keybinding
{
    public class KeybindManager : Manager
    {
        ...
        public static List<KeyBind> DefaultKeyBindings { get; } = new List<KeyBind>()
        {
            ...
            { new KeyBind(KeyBind.GameKeys.C, KeyBind.Modifiers.Alt, "closewindow GameWindowContainer") },
            ...
            { new KeyBind(KeyBind.GameKeys.F1, KeyBind.Modifiers.Alt, "loaddefaultlayout") },
            { new KeyBind(KeyBind.GameKeys.F2, KeyBind.Modifiers.Alt, "loadcharacterlayout") },
            { new KeyBind(KeyBind.GameKeys.F3, KeyBind.Modifiers.Alt, "loadlayoutfile custom.layout") },
        };
    }
